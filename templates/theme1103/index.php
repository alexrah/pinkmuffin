...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $gantry->language; ?>" lang="<?php echo $gantry->language;?>" >
	...
	<body <?php echo $gantry->displayBodyTag();  echo ' ' . $pageID; ?>>
		...
		<div id="wrapper" class="<?php echo $class .' '. $view .' '. $option . ' ' . $task; ?>">
					...
					<div class="rt-container">
						<?php echo $gantry->displayModules('footer','standard','standard'); ?>
						 <?php if ($class=="homepage" )  { ?>
							 More <a  rel='nofollow' href='http://www.templatemonster.com/category/sweet-shop-joomla-templates/' target='_blank'>Sweet Shop Joomla Templates at TemplateMonster.com</a>
						 <?php } ?>
						<div class="clear"></div>
					</div>
				</div>
