...
<?php if(count($items)): ?>
    <div id="slider-container" class="<?php echo 'theme-'.$params->get("theme"); ?>">
		<ul id="slider" class="nivoSlider" style="width:<?php echo $params->get("width"); ?>; height:<?php echo $params->get("height"); ?>;">
				...
				<div class="inner">
					...
					<?php if($params->get('itemImage') && isset($item->image)): ?>
						<a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;
							...
							<img src="<?php echo $item->image; ?>" alt="<?php echo $item->title; ?>" title="#<?php echo "counter".$key; ?>" rel="<?php echo JURI::base().'images/thumb'.$key.'.jpg' ; ?>"/>
						</a>
					<?php endif; ?>
				</div>
			</li>
