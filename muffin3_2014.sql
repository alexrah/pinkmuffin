...
--
-- Host: 127.0.0.1
-- Generato il: Feb 03, 2014 alle 10:56
...
--
-- Struttura della tabella `os914_assets`
--
...
--
-- Dump dei dati per la tabella `os914_assets`
--
...
(44, 8, 22, 25, 2, 'com_content.category.10', 'Featured', ''),
(45, 8, 26, 39, 2, 'com_content.category.11', 'Articles', ''),
(46, 44, 23, 24, 3, 'com_content.article.9', 'Post', ''),
(47, 45, 27, 28, 3, 'com_content.article.10', 'Home', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(48, 45, 29, 30, 3, 'com_content.article.11', 'MENÚ &Cakes', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(49, 45, 31, 32, 3, 'com_content.article.12', 'Contacts', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(50, 45, 33, 34, 3, 'com_content.article.13', 'Veniteci a trovare di persona', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(51, 45, 35, 36, 3, 'com_content.article.14', 'Le ultime novitá', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(52, 45, 37, 38, 3, 'com_content.article.15', 'New Page', '');

-- --------------------------------------------------------

--
-- Struttura della tabella `os914_associations`
--
...
--
-- Struttura della tabella `os914_banners`
--
...
--
-- Struttura della tabella `os914_banner_clients`
--
...
--
-- Struttura della tabella `os914_banner_tracks`
--
...
--
-- Struttura della tabella `os914_categories`
--
...
--
-- Dump dei dati per la tabella `os914_categories`
--
...
(10, 44, 1, 13, 14, 1, 'featured', 'com_content', 'Featured', 'featured', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2013-07-26 17:20:24', 0, '0000-00-00 00:00:00', 0, '*'),
(11, 45, 1, 15, 16, 1, 'articles', 'com_content', 'Articles', 'articles', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2013-07-26 17:20:24', 0, '0000-00-00 00:00:00', 0, '*');

-- --------------------------------------------------------

--
-- Struttura della tabella `os914_contact_details`
--
...
--
-- Struttura della tabella `os914_content`
--
...
--
-- Dump dei dati per la tabella `os914_content`
--
...
--
-- Struttura della tabella `os914_content_rating`
--
...
--
-- Struttura della tabella `os914_core_log_searches`
--
...
--
-- Struttura della tabella `os914_extensions`
--
...
--
-- Dump dei dati per la tabella `os914_extensions`
--
...
--
-- Struttura della tabella `os914_finder_links`
--
...
--
-- Struttura della tabella `os914_finder_links_terms0`
--
...
--
-- Struttura della tabella `os914_finder_links_terms1`
--
...
--
-- Struttura della tabella `os914_finder_links_terms2`
--
...
--
-- Struttura della tabella `os914_finder_links_terms3`
--
...
--
-- Struttura della tabella `os914_finder_links_terms4`
--
...
--
-- Struttura della tabella `os914_finder_links_terms5`
--
...
--
-- Struttura della tabella `os914_finder_links_terms6`
--
...
--
-- Struttura della tabella `os914_finder_links_terms7`
--
...
--
-- Struttura della tabella `os914_finder_links_terms8`
--
...
--
-- Struttura della tabella `os914_finder_links_terms9`
--
...
--
-- Struttura della tabella `os914_finder_links_termsa`
--
...
--
-- Struttura della tabella `os914_finder_links_termsb`
--
...
--
-- Struttura della tabella `os914_finder_links_termsc`
--
...
--
-- Struttura della tabella `os914_finder_links_termsd`
--
...
--
-- Struttura della tabella `os914_finder_links_termse`
--
...
--
-- Struttura della tabella `os914_finder_links_termsf`
--
...
--
-- Struttura della tabella `os914_finder_taxonomy`
--
...
--
-- Dump dei dati per la tabella `os914_finder_taxonomy`
--
...
--
-- Struttura della tabella `os914_finder_taxonomy_map`
--
...
--
-- Struttura della tabella `os914_finder_terms`
--
...
--
-- Struttura della tabella `os914_finder_terms_common`
--
...
--
-- Dump dei dati per la tabella `os914_finder_terms_common`
--
...
--
-- Struttura della tabella `os914_finder_tokens`
--
...
--
-- Struttura della tabella `os914_finder_tokens_aggregate`
--
...
--
-- Struttura della tabella `os914_finder_types`
--
...
--
-- Struttura della tabella `os914_languages`
--
...
--
-- Dump dei dati per la tabella `os914_languages`
--
...
--
-- Struttura della tabella `os914_menu`
--
...
--
-- Dump dei dati per la tabella `os914_menu`
--
...
--
-- Dump dei dati per la tabella `os914_menu_types`
--

INSERT INTO `os914_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site'),
(7, 'ct-horizontal-menu', 'Content / Horizontal Menu', ''),
(8, 'ct-vertical-menu', 'Content / Vertical Menu', ''),
(9, 'ct-special-menu', 'Content / Special Menu', '');

-- --------------------------------------------------------

--
-- Struttura della tabella `os914_messages`
--
...
--
-- Struttura della tabella `os914_messages_cfg`
--
...
--
-- Struttura della tabella `os914_modules`
--
...
--
-- Dump dei dati per la tabella `os914_modules`
--
...
(94, 'WOWSlider Module1', '', '', 2, 'user3', 42, '2013-08-28 09:11:47', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_wowslider1', 1, 0, '', 0, '*'),
(95, 'Content / Horizontal Menu', '', '', 1, 'user3', 42, '2013-08-28 08:45:27', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"ct-horizontal-menu","startLevel":"1","endLevel":"0","showAllChildren":"1","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"art-vmenu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(96, 'eventi:', '', '\n            <p style="text-align: center;"><img width="169" height="227" alt="" class="art-lightbox" src="images/template-content/310048_581529598534167_394402478_n.jpg"><br></p>\n        \n        ', 1, 'left', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_custom', 1, 1, '{"prepare_content":"1","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
...
(102, 'Bontá fatte in casa', '', '<h1 style="text-align: center;"><strong>Bontá fatte in casa</strong></h1>', 2, 'banner1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"1","backgroundimage":"","layout":"_:default","moduleclass_sfx":"slogan","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
(103, 'BT Facebook LikeBox', '', '', 1, 'left', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_bt_facebooklikebox', 1, 0, '{"type":"likebox","profile":"https:\\/\\/www.facebook.com\\/zuck","href":"https:\\/\\/www.facebook.com\\/pages\\/Muffin-Cakes-Tea-Room\\/195613330459131\\/","width":"","height":"556","height_follow":"","layout":"standard","font":"","show_faces":"true","connections":"10","show_stream":"true","show_header":"true","force_wall":"false","colorscheme":"light","border_color":"","moduleclass_sfx":"","cache":"0","cache_time":"900","cachemode":"static"}', 0, '*');

-- --------------------------------------------------------

--
-- Struttura della tabella `os914_modules_menu`
--
...
--
-- Dump dei dati per la tabella `os914_modules_menu`
--
...
--
-- Struttura della tabella `os914_newsfeeds`
--
...
--
-- Struttura della tabella `os914_overrider`
--
...
--
-- Struttura della tabella `os914_redirect_links`
--
...
--
-- Struttura della tabella `os914_schemas`
--
...
--
-- Dump dei dati per la tabella `os914_schemas`
--
...
--
-- Struttura della tabella `os914_session`
--
...
--
-- Dump dei dati per la tabella `os914_template_styles`
--
...
(14, 'pinkmuffin_2aug_3', 0, '1', 'pinkmuffin_2Aug_3 - Default', '[]');

-- --------------------------------------------------------

--
-- Struttura della tabella `os914_updates`
--
...
--
-- Dump dei dati per la tabella `os914_updates`
--
...
(5, 1, 0, 0, 'Joomla', '', 'joomla', 'file', '', 0, '2.5.13', '', 'http://update.joomla.org/core/extension.xml', ''),
(6, 1, 0, 0, 'Joomla', '', 'joomla', 'file', '', 0, '2.5.14', '', 'http://update.joomla.org/core/extension.xml', ''),
(7, 1, 0, 0, 'Joomla', '', 'joomla', 'file', '', 0, '2.5.14', '', 'http://update.joomla.org/core/extension.xml', ''),
(8, 1, 0, 0, 'Joomla', '', 'joomla', 'file', '', 0, '2.5.14', '', 'http://update.joomla.org/core/extension.xml', ''),
(9, 1, 0, 0, 'Joomla', '', 'joomla', 'file', '', 0, '2.5.14', '', 'http://update.joomla.org/core/extension.xml', ''),
(10, 1, 0, 0, 'Joomla', '', 'joomla', 'file', '', 0, '2.5.14', '', 'http://update.joomla.org/core/extension.xml', ''),
(11, 1, 0, 0, 'Joomla', '', 'joomla', 'file', '', 0, '2.5.14', '', 'http://update.joomla.org/core/extension.xml', ''),
(12, 1, 0, 0, 'Joomla', '', 'joomla', 'file', '', 0, '2.5.14', '', 'http://update.joomla.org/core/extension.xml', ''),
(13, 1, 0, 0, 'Joomla', '', 'joomla', 'file', '', 0, '2.5.14', '', 'http://update.joomla.org/core/extension.xml', ''),
(14, 1, 0, 0, 'Joomla', '', 'joomla', 'file', '', 0, '2.5.14', '', 'http://update.joomla.org/core/extension.xml', '');

-- --------------------------------------------------------

--
-- Struttura della tabella `os914_update_categories`
--
...
--
-- Struttura della tabella `os914_update_sites`
--
...
--
-- Dump dei dati per la tabella `os914_update_sites`
--

INSERT INTO `os914_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1377937383),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1377937383);

-- --------------------------------------------------------

--
-- Struttura della tabella `os914_update_sites_extensions`
--
...
--
-- Dump dei dati per la tabella `os914_update_sites_extensions`
--
...
--
-- Struttura della tabella `os914_usergroups`
--
...
--
-- Dump dei dati per la tabella `os914_usergroups`
--
...
--
-- Struttura della tabella `os914_users`
--
...
--
-- Dump dei dati per la tabella `os914_users`
--
...
(42, 'Super User', 'admin', 'alexrah@gmail.com', '55dd29ce17e038ba91db6040de7ca868:GVHW4PaoxiJYTECifcwPgpxbDz2AaMBb', 'deprecated', 0, 1, '2013-07-19 14:38:59', '2013-08-31 08:22:59', '0', '');

-- --------------------------------------------------------

--
-- Struttura della tabella `os914_user_notes`
--
...
--
-- Struttura della tabella `os914_user_profiles`
--
...
--
-- Struttura della tabella `os914_user_usergroup_map`
--
...
--
-- Dump dei dati per la tabella `os914_user_usergroup_map`
--
...
--
-- Struttura della tabella `os914_viewlevels`
--
...
--
-- Dump dei dati per la tabella `os914_viewlevels`
--
...
--
-- Struttura della tabella `os914_weblinks`
--
